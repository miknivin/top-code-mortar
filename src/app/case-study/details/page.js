            ...
            <div className="col-lg-8">
              <div className="details-content-wrap">
                <div className="post-thumb two mb-70">
                  <img
                    src="/assets/img/innerpages/case-study-details-thumb-img.jpg"
                    alt=""
                  />
                </div>
                ...
                <p>
                  Brightwave Electronics, a mid-sized electronics manufacturer
                  specializing in eco-friendly consumer devices, faced
                  challenges in connecting with its audience due to an outdated
                  brand image. The company wanted a brand identity that
                  reflected its commitment to innovation and sustainability.
                </p>
                <span className="line-break" />
                <span className="line-break" />
                <span className="line-break" />
                ...
                <ul className="listing three">
                  <li>
                    <span>Outdated Brand Perception:</span> The company was
                    perceived as traditional and conservative, which didn’t
                    align with its eco-friendly and innovative product lines.
                  </li>
                  <li>
                    <span>Lack of Brand Differentiation:</span> In a competitive
                    market, the existing brand lacked elements that set it apart
                    from other players.
                  </li>
                </ul>
                <span className="line-break" />
                ...
                <ul className="listing three">
                  <li>
                    <span>Rebranding for Alignment:</span> Ensuring the brand
                    identity matched company values attracted a loyal, aligned
                    customer base.
                  </li>
                  <li>
                    <span>Employee Involvement:</span> Employees play a crucial
                    role in successful rebranding, as they embody the brand’s
                    values.
                  </li>
                </ul>
                <span className="line-break" />
                ...
                <div className="img-grp mb-130">
                  <div className="row g-4">
                    <div className="col-xl-8 col-md-7">
                      <img
                        src="/assets/img/innerpages/case-study-details-img1.jpg"
                        alt=""
                      />
                    </div>
                    <div className="col-xl-4 col-md-5">
                      <img
                        src="/assets/img/innerpages/case-study-details-img2.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                ...
                <div className="details-pagination">
                  <div className="single-pagination">
                    ...
                    >
                      <img
                        src="/assets/img/innerpages/details-pagination-btn-bg5.png"
                        alt=""
                      />
                    ...
                    <div className="content">
                      <h6>
                        <Link href="/news-insight-grid/details">
                          Crafting a Seamless Digital Presence for DEF
                          Technology.
                        </Link>
                      </h6>
                    </div>
                  ...
                  <div className="single-pagination two text-end">
                    <div className="content">
                      <h6>
                        <Link href="/news-insight-grid/details">
                          Increasing Lead Generation Through Campaigns.
                        </Link>
                      </h6>
                    </div>
                    <Link
            ...
            <div className="col-lg-4">
              <div className="case-study-details-sidebar">
                <div className="case-study-details-info-wrap">
                  ...
                  <ul className="download-btns">
                    <li>
                      ...
                      >
                        <img
                          src="/assets/img/innerpages/icon/pdf-icon2.svg"
                          alt=""
                        />
                        Download Pdf
                        <span />
                ...
                <div className="note-area">
                  ...
                  <div className="content">
                    <p>
                      <span>Increased Brand Awareness:</span> Following the
                      rebrand, Brightwave reported a <span>35% increase</span>{" "}
                      in brand recognition and media mentions.
                    </p>
                    <ul>
                      <li>
                        <h6>
