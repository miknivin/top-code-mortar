...
const CarrerPage = () => {
  return (
    <>
        ...
        <div className="container">
          <div className="title-area">
            <div className="row g-4 justify-content-between mb-70">
              <div
                className="col-xl-4 col-lg-5 wow animate fadeInLeft"
              ...
              >
                <div className="content">
                  <p>
                    We’re passionate about delivering innovative digital
                    solutions. Our team is made up of creative thinkers,
                    problem-solvers, and experts in their fields. We’re always
                    on the lookout for talented individuals who share our drive
                    to make an impact.
                  </p>
          ...
          <div className="row g-4">
            <div
              className="col-lg-3 col-md-6 wow animate fadeInDown"
              data-wow-delay="200ms"
              data-wow-duration="1500ms"
            >
            ...
            >
              <div className="single-feature three magnetic-item">
                ...
                <p>
                  Flexible hours &amp; a supportive team mean to balance work.
                </p>
              </div>
            </div>
            <div
      ...
      <div
        className="career-page-thumb mb-130"
        style={{
          backgroundImage:
            "url(assets/img/innerpages/career-page-thumb-img1.jpg)",
        }}
      ></div>
              ...
              >
                <div className="content">
                  <p>
                    We’re passionate about delivering innovative digital
                    solutions. Our team is made up of creative thinkers,
                    problem-solvers, and experts in their fields.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row g-4">
            ...
            >
              <div className="single-benefit two">
                <h5>
                  <span>1.</span> Competitive Salary &amp; Performance Bonuses.
                </h5>
              </div>
            </div>
            <div
            ...
            >
              <div className="single-benefit">
                <h5>
                  <span>2.</span> Health, Dental, and Vision Insurance.
                </h5>
              </div>
            </div>
            <div
            ...
            >
              <div className="single-benefit three">
                <h5>
                  <span>3.</span> Remote Work Opportunities.
                </h5>
              </div>
            </div>
            <div
            ...
            >
              <div className="single-benefit">
                <h5>
                  <span>4.</span> Paid Time Off &amp; Holidays
                </h5>
              </div>
            </div>
            <div
            ...
            >
              <div className="single-benefit four">
                <h5>
                  <span>5.</span> Employee Wellness Programs
                </h5>
              </div>
            </div>
            <div
            ...
            >
              <div className="single-benefit">
                <h5>
                  <span>6.</span> Transportation &amp; Commuting Benefits.
                </h5>
              </div>
            </div>
            <div
            ...
            >
              <div className="single-benefit five">
                <h5>
                  <span>7.</span> Collaborative &amp; Inclusive Work Culture.
                </h5>
              </div>
            </div>
            <div
            ...
            >
              <div className="single-benefit">
                <h5>
                  <span>8.</span> Learning &amp; Development Programs.
                </h5>
              </div>
            </div>
            <div
            ...
            >
              <div className="single-benefit six">
                <h5>
                  <span>9.</span> Career Growth Opportunities
                </h5>
              </div>
            </div>
          </div>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(assets/img/innerpages/career-page-thumb-img2.jpg)",
        }}
      ></div>
      {/* Career Page Thumb End */}
          ...
          >
            <div className="col-lg-6 col-md-8">
              <div className="section-title three">
                ...
                <p>
                  We’re seek a passinate &amp; self-motivated person to work our
                  stakholders.
                </p>
              </div>
            </div>
                ...
                <ul className="info-area">
                  ...
                  <li>
                    ...
                    <div className="content">
                      ...
                      <strong>
                        $90K-$160K <span className="text-grey">( Annualy)</span>
                      </strong>
                    </div>
                  </li>
                </ul>
                ...
                <ul className="info-area">
                  ...
                  <li>
                    ...
                    <div className="content">
                      ...
                      <strong>
                        $60K-$150K <span className="text-grey">( Annualy)</span>
                      </strong>
                    </div>
                  </li>
                </ul>
                ...
                <ul className="info-area">
                  ...
                  <li>
                    ...
                    <div className="content">
                      ...
                      <strong>
                        $90K-$170K <span className="text-grey">( Annualy)</span>
                      </strong>
                    </div>
                  </li>
                </ul>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-6 col-lg-7">
              <div
                className="section-title three text-center mb-60 wow animate fadeInDown"
                data-wow-delay="200ms"
                data-wow-duration="1500ms"
              >
                ...
                >
                  ...
                  >
                    <h5 className="accordion-header" id="flush-headingOne">
                      ...
                      >
                        How do I apply for a job at Topcode
                      </button>
                    </h5>
                    <div
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        portfolio (if applicable). You can also send your
                        application to (
                  ...
                  >
                    ...
                    >
                      <div className="accordion-body">
                        The interview process typically includes an initial
                        application review, followed by a phone or video
                        screening. If you pass, you'll be invited to one or more
                        in-depth interviews, which may be technical, behavioral,
                        or case-based, depending on the role.
                      </div>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <div className="accordion-body">
                        Yes, we offer remote work opportunities depending on the
                        role and team requirements. We believe in flexibility
                        and work-life balance, allowing employees to work
                        remotely or in a hybrid model where applicable
                      </div>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <div className="accordion-body">
                        We seek passionate, skilled candidates who excel in
                        collaboration, innovation, and problem-solving. Relevant
                        experience, technical expertise, and strong
