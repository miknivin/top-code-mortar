...
import Home1WhyUsSection from "@/components/whyUs/WhyUsSection";
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="banner-content">
                  ...
                  <h1>Made to Make Impact.</h1>
                  <p>
                    Good ideas deserve great execution — that’s where we come in
                  </p>
              ...
              <div className="col-lg-6 d-lg-block d-none">
                <div className="bannner-img-wrap">
                  ...
                  <img
                    src="/assets/img/home1/banner-img-bg-vector.png"
                    alt=""
                    className="banner-img-bg light"
                  />
                  <img
                    src="/assets/img/home1/banner-img-bg-vector-dark.png"
                    alt=""
                    className="banner-img-bg dark"
                  />
                </div>
              </div>
            </div>
