                  ...
                  <div className="col-lg-6 col-md-7 col-sm-6">
                    <div className="blog-content-wrap">
                      <ul className="blog-meta">
                        <li>
                          <Link href="/news-insight-grid">Creative Design</Link>
                        </li>
                        <li>
                          <svg
                            width={30}
                        ...
                        <li className="blog-date">
                          <Link href="/news-insight-grid">02 April, 2023</Link>
                        </li>
                      </ul>
                      <h3>
                ...
                <div className="row align-items-center g-xl-4 g-lg-2 g-md-4 g-sm-3 g-4">
                  ...
                  <div className="col-lg-6 col-md-7 col-sm-6">
                    <div className="blog-content-wrap">
                      <ul className="blog-meta">
                        <li>
                          <Link href="/news-insight-grid">Design Trends</Link>
                        </li>
                        <li>
                          <svg
                            width={30}
                        ...
                        <li className="blog-date">
                          <Link href="/news-insight-grid">05 April, 2023</Link>
                        </li>
                      </ul>
                      <h3>
                        <Link href="/news-insight-grid/details">
                ...
                <div className="row align-items-center g-xl-4 g-lg-2 g-md-4 g-sm-3 g-4">
                  ...
                  <div className="col-lg-6 col-md-7 col-sm-6">
                    <div className="blog-content-wrap">
                      <ul className="blog-meta">
                        <li>
                          <Link href="/news-insight-grid">Bento Grid</Link>
                        </li>
                        <li>
                          <svg
                            width={30}
                ...
                <div className="row align-items-center g-xl-4 g-lg-2 g-md-4 g-sm-3 g-4">
                  ...
                  <div className="col-lg-6 col-md-7 col-sm-6">
                    <div className="blog-content-wrap">
                      ...
                      <h3>
                        <Link href="/news-insight-grid/details">
                          Navigating the Challenges of E-commerce in -2025.
                        </Link>
                      </h3>
                      <Link
                        href="/news-insight-grid/details"
                ...
                <div className="row align-items-center g-xl-4 g-lg-2 g-md-4 g-sm-3 g-4">
                  ...
                  <div className="col-lg-6 col-md-7 col-sm-6">
                    <div className="blog-content-wrap">
                      <ul className="blog-meta">
                        <li>
                          <Link href="/news-insight-grid">Web Design</Link>
                        </li>
                        <li>
                          <svg
                            width={30}
                      ...
                      <h3>
                        <Link href="/news-insight-grid/details">
                          The Power of Influencer Marketing Insights and Tips.
                        </Link>
                      </h3>
                      <Link
                        href="/news-insight-grid/details"
