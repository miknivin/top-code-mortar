          ...
          >
            <div className="col-lg-5">
              <div className="section-title three">
                <h2>They Loves Us</h2>
                <p>
                  We’re the greatest part on the digital platform &amp; to
                  achieve many awards.
                </p>
              </div>
            </div>
          ...
          <div className="testimonial-wrap">
                    ...
                    <div className="swiper-wrapper">
                      <SwiperSlide className="swiper-slide">
                        <div className="testimonial-card two">
                          <div className="company-logo">
                            <img
                              src="/assets/img/home1/testimonial-company-logo1.png"
                              alt=""
                              className="light"
                            />
                            <img
                              src="/assets/img/home1/testimonial-company-logo1-white.png"
                              alt=""
                              className="dark"
                            />
                          </div>
                          <div className="testimonial-content">
                            <p>
                              Outstanding Apps! They are very helpful &amp;
                              mindblowing to get services. Providing
                              comprehensive care and creativity for customer
                              satisfaction.
                            </p>
                          </div>
                      ...
                      <SwiperSlide className="swiper-slide">
                        <div className="testimonial-card two">
                          <div className="company-logo">
                            <img
                              src="/assets/img/home1/testimonial-company-logo2.png"
                              alt=""
                              className="light"
                            />
                            <img
                              src="/assets/img/home1/testimonial-company-logo2-white.png"
                              alt=""
                              className="dark"
                            />
                          </div>
                          <div className="testimonial-content">
                            <p>
                              Excellent Work! Evaluate the effectiveness of the
                              team’s communication and collaboration throughout
                              the project. I prefer that.
                            </p>
                          </div>
                          <div className="author-area">
                            <div className="author-img">
                      ...
                      <SwiperSlide className="swiper-slide">
                        <div className="testimonial-card two">
                          <div className="company-logo">
                            <img
                              src="/assets/img/home1/testimonial-company-logo3.png"
                              alt=""
                              className="light"
                            />
                            <img
                              src="/assets/img/home1/testimonial-company-logo3-white.png"
                              alt=""
                              className="dark"
                            />
                          </div>
                          <div className="testimonial-content">
                            <p>
                              Fantastic Apps! They provide amazing services and
                              are very helpful. delivering all-encompassing care
                              and innovation to ensure client happiness.
                            </p>
                          </div>
                          <div className="author-area">
                            <div className="author-img">
                  ...
                  <div className="slider-btn-grp">
                    ...
                    >
                      ...
                      >
                        <g>
                          <path
                            d="M10.9999 13.0009C9.99994 10.5009 4.99994 8.00092 1.99994 7.00092C4.99994 6.00092 9.49994 4.50092 10.9999 1.00092"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                        </g>
                    ...
                    >
                      ...
                      >
                        <g>
                          <path
                            d="M3 13.0009C4 10.5009 9 8.00092 12 7.00092C9 6.00092 4.5 4.50092 3 1.00092"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                          />
                        </g>
                  ...
                  <li>
                    <a href="#" className="single-rating two">
                      ...
                      <div className="rating">
                        ...
                        <span>
                          GOOGLE REVIEW <strong>(4.5)</strong>
                        </span>
                      </div>
                    </a>
                  </li>
            ...
            <ul className="img-list">
              <li className="single-img">
                <img
                  src="/assets/img/innerpages/about-page-testmonial-img1.png"
                  alt=""
                />
              </li>
              <li className="single-img">
                <img
                  src="/assets/img/innerpages/about-page-testmonial-img2.png"
                  alt=""
                />
              </li>
              <li className="single-img">
                <img
                  src="/assets/img/innerpages/about-page-testmonial-img3.png"
                  alt=""
                />
              </li>
              <li className="single-img">
                <img
                  src="/assets/img/innerpages/about-page-testmonial-img4.png"
                  alt=""
                />
              </li>
              <li className="single-img">
                <img
                  src="/assets/img/innerpages/about-page-testmonial-img5.png"
                  alt=""
                />
              </li>
              <li className="single-img">
                <img
                  src="/assets/img/innerpages/about-page-testmonial-img6.png"
                  alt=""
                />
              </li>
            </ul>
