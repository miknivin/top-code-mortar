          ...
          <div className="details-content-wrap mb-130">
            ...
            <div className="row gy-4 justify-content-between mb-70">
              <div className="col-xl-5 col-lg-6">
                ...
                <p>
                  We specialize in creating dynamic, visually engaging, and
                  fully optimized websites that drive results. Our web
                  development and design services are tailored to meet your
                  specific business goals, ensuring a seamless online presence
                  that not only looks great but also performs exceptionally.
                </p>
                <span className="line-break" />
                <p>
              ...
              <div className="col-xl-5 col-lg-6">
                ...
                <span className="line-break" />
                <p>
                  Here are some key features of Web Development &amp; Design
                  that highlight:
                </p>
                <span className="line-break" />
