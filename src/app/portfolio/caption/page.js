          ...
          <div className="row gy-5 justify-content-between mb-70">
            ...
            >
              <div className="portfolio-caption-card magnetic-item">
                <Link
                  ...
                  className="portfolio-caption-img"
                >
                  <img
                    src="/assets/img/innerpages/portfolio-caption-img1.jpg"
                    alt=""
                  />
                </Link>
            ...
            >
              <div className="portfolio-caption-card magnetic-item">
                ...
                >
                  <img
                    src="/assets/img/innerpages/portfolio-caption-img2.jpg"
                    alt=""
                  />
                </Link>
                <div className="info-flow-content">
            ...
            >
              <div className="portfolio-caption-card magnetic-item">
                ...
                >
                  <img
                    src="/assets/img/innerpages/portfolio-caption-img3.jpg"
                    alt=""
                  />
                </Link>
                <div className="info-flow-content">
                  ...
                  <h6>
                    <Link href="/portfolio/details">Interactive Design.</Link>
                  </h6>
                </div>
              </div>
            </div>
            ...
            >
              <div className="portfolio-caption-card magnetic-item">
                ...
                >
                  <img
                    src="/assets/img/innerpages/portfolio-caption-img4.jpg"
                    alt=""
                  />
                </Link>
                <div className="info-flow-content">
                  ...
                  <h6>
                    <Link href="/portfolio/details">Seamless Interfaces.</Link>
                  </h6>
                </div>
              </div>
            </div>
            ...
            >
              <div className="portfolio-caption-card magnetic-item">
                ...
                >
                  <img
                    src="/assets/img/innerpages/portfolio-caption-img5.jpg"
                    alt=""
                  />
                </Link>
                <div className="info-flow-content">
                  ...
                  <h6>
                    <Link href="/portfolio/details">Scalable Web Designs.</Link>
                  </h6>
                </div>
              </div>
            </div>
