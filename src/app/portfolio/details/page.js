          ...
          <div className="details-content-wrap portfolio-details mb-130">
            <div className="post-title-and-tag">
              ...
              <ul className="tag-list">
                <li>
                  <Link href="/portfolio/classic">Branding</Link>
                </li>
                <li>
                  <Link href="/portfolio/classic">UI/UX Design</Link>
                </li>
                <li>
                  <Link href="/portfolio/classic">Typhography</Link>
                </li>
                <li>
                  <Link href="/portfolio/classic">Hierarchy</Link>
                </li>
              </ul>
            </div>
                ...
                <div className="col-xl-8 col-lg-10">
                  <div className="portfolio-details-info-area">
                    <ul className="info-box">
                      ...
                      <li className="info-item">
                        <strong>Clients:</strong> Mr. Marko Paul
                      </li>
                      <li className="info-item">
                        <strong>Solution:</strong> Digital Marketing
                      </li>
                      <li className="info-item">
                        <strong>Date:</strong> 12/22/2023
                      </li>
                    </ul>
            ...
            <div className="row g-4 justify-content-between">
              ...
              <div className="col-xl-5 col-lg-6">
                ...
                <span className="line-break two" />
                <p>
                  This project focused on helping Marko Paul enhance their
                  online presence through a{" "}
                  <span>complete website redesign</span> and{" "}
            ...
            <div className="row gy-5 justify-content-between">
              <div className="col-xl-5 col-lg-6">
                ...
                <span className="line-break" />
                <p>
                  A list of the specific services we delivered for the project,
                  such as:
                </p>
                <span className="line-break" />
              ...
              <div className="col-xl-5 col-lg-6">
                ...
                <span className="line-break" />
                <p>
                  The primary challenge was creating a user-friendly website
                  that{" "}
                  <span>
                    improved navigation while increasing conversion rates in a
            ...
            <div className="img-grp">
              <div className="row g-lg-4 g-md-3 g-4">
                <div className="col-lg-4 col-md-4">
                  <img
                    src="/assets/img/innerpages/portfolio-details-img1.jpg"
                    alt=""
                  />
                </div>
                <div className="col-lg-5 col-md-5">
                  <img
                    src="/assets/img/innerpages/portfolio-details-img2.jpg"
                    alt=""
                  />
                </div>
                <div className="col-lg-3 col-md-3">
                  <img
                    src="/assets/img/innerpages/portfolio-details-img3.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="row gy-5 justify-content-between">
              <div className="col-xl-5 col-lg-6">
                ...
                <span className="line-break" />
                <p>
                  Present measurable results achieved after the project launch.
                  This section should be data-driven to show the impact of your
                  work, such as:
                </p>
                <span className="line-break" />
            ...
            <span className="line-break" />
            <img
              src="/assets/img/innerpages/portfolio-details-img4.jpg"
              alt=""
            />
            <span className="line-break" />
            <span className="line-break" />
