  ...
  return (
    <div className="home6-faq-section mb-130">
      <div className="container">
        <div
          className="row justify-content-center mb-65 wow animate fadeInDown"
        ...
        >
          <div className="col-xxl-4 col-lg-5 col-md-7">
            <div className="section-title text-center">
              <h2>FAQ’s</h2>
              <p>
                Here's a list of frequently asked questions (FAQs) for a project
                management
              </p>
            </div>
          </div>
              ...
              >
                ...
                >
                  <h5 className="accordion-header" id="flush-headingOne">
                    ...
                    >
                      What integrations are available with Topcode?
                    </button>
                  </h5>
                  <div
                  ...
                  >
                    <div className="accordion-body">
                      Topcode integrates with a{" "}
                      <strong>15+ of platforms</strong> to enhance customer
                      support and business insights. <br />
                      Some of the key integrations available include:
                      <ul>
                        <li>
                          <span>Mailchimp -</span> For managing email marketing
                          campaigns.
                        </li>
                        <li>
                          <span>Slack -</span> For collaboration individual or
                          team members easily.
                        </li>
                        <li>
                          <span>WhatsApp -</span> For direct messaging with our
                          customer support team inbox.
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                >
                  <h5 className="accordion-header" id="flush-headingThree">
                    ...
                    >
                      How does Topcode ensure the security of my data?
                    </button>
                  </h5>
                  <div
        ...
        <div
          className="button-area text-center wow animate fadeInUp"
          data-wow-delay="200ms"
          data-wow-duration="1500ms"
        >
