        ...
        <div className="row g-4 align-items-center justify-content-between mb-60">
          ...
          >
            <div className="section-title three">
              <span>About Topcode</span>
              <h2>Make Brands in the Digital World.</h2>
              <p>
                We provides a wide range of services aimed at helping{" "}
                <span>Businesses, Organizations,</span> &amp; individuals thrive
                in the digital space.
              </p>
            </div>
          </div>
          <div
            className="col-xl-4 col-lg-5 wow animate fadeInRight"
            data-wow-delay="200ms"
            data-wow-duration="1500ms"
          >
            <div className="achievment-area">
              ...
              <div className="content">
                <h6>Achievment</h6>
                <p>
                  An award-winning<span>“Digital Excellence Awards”</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row g-4 justify-content-xl-end mb-50">
          ...
          >
            <div className="about-feature-card magnetic-item">
              ...
              >
                <path
                  d="M1 32L31 2M31 2C24.3333 3.25 9.75 5.75 1 2M31 2C29.75 8.25 27.25 22 31 32"
                  strokeWidth={2}
                  strokeLinecap="round"
                />
              </svg>
          ...
          <div
            className="col-xl-5 col-lg-4 col-md-6 wow animate fadeInDown"
