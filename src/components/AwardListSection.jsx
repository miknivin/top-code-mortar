        ...
        <div className="row justify-content-center mb-70">
          <div className="col-lg-6">
            <div className="section-title three">
              <h2>We’re not just another digital agency. </h2>
              <h2 >We’re your growth partner</h2>
              <p>
                In today’s fast-moving world, it’s not enough to have a great product—you need the strategy, the brand, the content, and the tech to make it unforgettable. That’s where we come in.
              </p>
            </div>
          </div>
        </div>
                ...
                {awards.map((_, index) => (
                  ...
                  >
                    <div className="award-img">
                      <img
                        src={`/assets/img/innerpages/award-img-0${
                          index + 1
                        }.png`}
                        alt=""
                        className="light"
