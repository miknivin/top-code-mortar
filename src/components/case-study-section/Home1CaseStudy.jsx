        ...
        >
          <div className="col-lg-12 d-flex align-items-lg-end justify-content-between gap-3 flex-wrap">
            <div className="section-title">
              ...
              <h2>Blogs</h2>
              <p>
                We simplify complex challenges with a streamlined, four-step
                process.
              </p>
            </div>
          ...
          >
            <div className="case-study-card magnetic-item">
              ...
              <div className="case-study-card-content">
                ...
                <p>
                  Allow for ample white space to avoid overwhelming the reader.
                  White space helps in emphasizing key points.
                </p>
                <ul>
                  <li>
                    <span>Key Word</span>
          ...
          >
            <div className="case-study-card magnetic-item">
              ...
              <div className="case-study-card-content">
                <h3>
                  <Link href="/case-study/details">
                    Rovik's Transition to a Cloud-First Strategy.
                  </Link>
                </h3>
                <p>
                  Allow for ample white space to avoid overwhelming the reader.
