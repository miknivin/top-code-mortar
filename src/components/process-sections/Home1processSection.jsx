          ...
          >
            <div className="col-lg-12">
              <div className="section-title">
                ...
                <h2>Solution in Five Step.</h2>
                <p>
                  We simplify complex challenges with a streamlined, five-step
                  process.
                </p>
              </div>
            </div>
          ...
          <div className="process-slider-area">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="process-card">
                        ...
                        <div className="process-content">
                          <h5>Understand</h5>
                          <p>
                            Understand the client's vision, goals, &amp;
                            challenges.
                          </p>
                          <ul>
                            <li>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="process-card">
                        ...
                        <div className="process-content">
                          <h5>Strategize</h5>
                          <p>
                            Crafting clear, data-driven plans for impactful
                            growth.
                          </p>
                          <ul>
                            <li>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="process-card">
                        ...
                        <div className="process-content">
                          ...
                          <p>
                            Bringing strategy to life with precision and speed.
                          </p>
                          <ul>
                            <li>
                              <svg
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="process-card">
                        ...
                        <div className="process-content">
                          ...
                          <p>
                            Maximizing impact through continuous improvement.
                          </p>
                          <ul>
                            <li>
                              <svg
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="process-card">
                        ...
                        <div className="process-content">
                          ...
                          <p>
                            Empowering progress through constant improvement.
                          </p>
                          <ul>
                            <li>
                              <svg
            ...
            <div className="slider-btn-grp">
              <div
                ...
                className="slider-btn process-slider-prev"
              >
                <svg
                  width={9}
                  height={10}
              ...
              <div
                style={{ cursor: "pointer" }}
                className="slider-btn process-slider-next"
              >
                <svg
                  width={9}
                  height={10}
