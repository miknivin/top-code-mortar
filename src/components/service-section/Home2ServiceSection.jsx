    ...
    <>
      ...
      <div className="home2-global-map-section mb-130">
        <div className="container">
          <div className="banner-content">
            <div
              className="section-title two white wow animate fadeInDown"
              data-wow-delay="200ms"
              data-wow-duration="1500ms"
            >
              <span>100% Secure Transaction</span>
              <h2>Global Impact of Topcode</h2>
              <p>
                Topcode is essential in binding bricks, stones, and concrete
                blocks together, providing the structural integrity needed for
        ...
        <div className="globe-area">
          <div className="location">
            ...
            <div className="content">
              <img
                src="/assets/img/home2/globe-area-location-branch-icon.svg"
                alt=""
              />
      ...
      <div className="home2-transaction-section mb-130">
        <div className="container">
                ...
                <div className="transaction-tool-area">
                  <ul className="transaction-tool-list">
                    <li className="single-tool">
                      <img
                        src="/assets/img/home2/icon/mobile-pay-logo.svg"
                        alt=""
                      />
                    </li>
                    <li className="single-tool two">
                      <img
                        src="/assets/img/home2/icon/paypal-logo.svg"
                        alt=""
                      />
                    </li>
                  </ul>
                  <ul className="transaction-tool-list">
                    <li className="single-tool">
                      <img
                        src="/assets/img/home2/icon/google-pay-logo.svg"
                        alt=""
                      />
                    </li>
                    <li className="single-tool two">
                      <img
                        src="/assets/img/home2/icon/google-pay-logo2.svg"
                        alt=""
                      />
                    </li>
                    <li className="single-tool">
                      <img
                        src="/assets/img/home2/icon/master-card-logo.svg"
                        alt=""
                      />
                    </li>
                    <li className="single-tool two">
                      <img
                        src="/assets/img/home2/icon/google-wallet-logo.svg"
                        alt=""
                      />
                    </li>
                  </ul>
                  <ul className="transaction-tool-list">
                    <li className="single-tool">
                      <img
                        src="/assets/img/home2/icon/maestro-logo.svg"
                        alt=""
                      />
                    </li>
                    <li className="single-tool two">
                ...
                <div className="logo-and-vector">
                  <div className="company-logo-wrap">
                    <div className="company-logo">
                      <img
                        src="/assets/img/home2/transaction-company-logo.svg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  >
                    <path
                      id="theMo1tionPath11"
                      d="M0 203H182C187.523 203 192 198.523 192 193V133C192 127.477 196.477 123 202 123H518C523.523 123 528 127.477 528 133V193C528 198.523 532.477 203 538 203H720"
                    />
                    ...
                    <path
                      id="theMo1tionPath13"
                      d="M0 3H182C187.523 3 192 7.47715 192 13V73C192 78.5228 196.477 83 202 83H518C523.523 83 528 78.5228 528 73V13C528 7.47715 532.477 3 538 3H720"
                    />
                    <circle cx={0} cy={0} r={3}>
                      <animateMotion
                        dur="4s"
              ...
              <div className="col-lg-4 d-flex justify-content-lg-end justify-content-center">
                <div className="transaction-tool-area">
                  <ul className="transaction-tool-list">
                    <li className="single-tool">
                      <img
                        src="/assets/img/home2/icon/barber-shop-logo.svg"
                        alt=""
                      />
                    ...
                    <li className="single-tool two">
                      <img
                        src="/assets/img/home2/icon/baeuty-logo.svg"
                        alt=""
                      />
                  ...
                  <ul className="transaction-tool-list">
                    <li className="single-tool">
                      <img
                        src="/assets/img/home2/icon/grocery-logo.svg"
                        alt=""
                      />
                      <span>Grocery</span>
                    </li>
                    <li className="single-tool two">
                      <img
                        src="/assets/img/home2/icon/booking-logo.svg"
                        alt=""
                      />
                      <span>Booking</span>
                    </li>
                    <li className="single-tool">
                      <img
                        src="/assets/img/home2/icon/ecommerec-logo.svg"
                        alt=""
                      />
                  ...
                  <ul className="transaction-tool-list">
                    <li className="single-tool">
                      <img
                        src="/assets/img/home2/icon/doctor-appointment-logo.svg"
                        alt=""
                      />
                    ...
                    <li className="single-tool two">
                      <img
                        src="/assets/img/home2/icon/coffee-shop-logo.svg"
                        alt=""
                      />
          ...
          <div
            className="home2-process-section wow animate fadeInUp"
            data-wow-delay="200ms"
            data-wow-duration="1500ms"
          >
              ...
              <div className="row gy-md-4 gy-5 justify-content-center">
                <div className="col-lg-4 col-sm-6">
                  <div className="single-process">
                    ...
                    <p>
                      Through <span>register/login</span>, you may get to
                      permission payment transaction by{" "}
                      <span>Topcode App.</span>
                    </p>
                  </div>
                </div>
                <div className="col-lg-4 col-sm-6 d-flex justify-content-lg-center">
                  <div className="single-process">
                    ...
                    <p>
                      Transaction via any payment meyhod like{" "}
                      <span>Payple, Stripe</span> &amp; <span>Mastercard</span>{" "}
                      etc. easily
                    </p>
                  </div>
                </div>
                <div className="col-lg-4 col-sm-6 d-flex justify-content-lg-end">
                  <div className="single-process">
                    ...
                    <p>
                      Enjoy with <span>Topcode App</span> for money transaction
                      with few second around the world-wide.
                    </p>
                  </div>
                </div>
              </div>
