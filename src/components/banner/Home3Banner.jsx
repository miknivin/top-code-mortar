            ...
            <div className="col-lg-6 d-lg-block d-none">
              <div className="home3-video-wrapper">
                <div className="video-area" ref={videoAreaRef}>
                  ...
                  />
                  <img
                    src="/assets/img/home3/banner-video-shape.png"
                    alt=""
                    className="banner-vector"
                  />
                  <div className="content">
                    <h6>Topcode . Digital Agency</h6>
                    <span>(2011-2024)</span>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="banner-content-wrap">
                <div className="banner-content">
                  ...
                  <h1>
                    Pioneering <span>Pro</span> Digital Excellence.
                  </h1>
                  <p>
                    We provides services related to online{" "}
                    <span>Marketing, Development, Design,</span> and other
