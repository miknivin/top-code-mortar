  ...
  return (
    <>
      <div className="home4-testimonial-section mb-130">
        <img
          src="/assets/img/home4/testimonial-bg.png"
          alt=""
          className="testimonial-bg light"
        />
        <img
          src="/assets/img/home4/testimonial-bg-dark.png"
          alt=""
          className="testimonial-bg dark"
        />
        <div className="container">
          <div className="row g-4">
            <div className="col-lg-9 position-relative">
              ...
              <div className="testimonial-area">
                ...
                >
                  ...
                  <p>
                    This feedback acknowledges strengths while providing
                    constructive input for improvement.
                  </p>
                </div>
                <Swiper
                  {...settings}
                  className="swiper home2-testimonial-slider mt-70"
                >
                        ...
                        <div className="row g-4">
                          <div className="col-xl-4 col-md-5">
                            <div className="testimonial-img">
                              <img
                                src="/assets/img/home4/testimonial-img1.png"
                                alt=""
                              />
                              <a
                          ...
                          <div className="col-md-7">
                            <div className="testimonial-content">
                              ...
                              <p>
                                We’ve been extremely pleased with the creativity
                                and strategic approach the agency brought to our
                                campaigns.
                              </p>
                      ...
                      <div className="testimonial-card4">
                        <div className="row g-4">
                          <div className="col-xl-4 col-md-5">
                            <div className="testimonial-img">
                              <img
                                src="/assets/img/home4/testimonial-img2.png"
                                alt=""
                              />
                              <a
                                style={{ cursor: "pointer" }}
                          ...
                          <div className="col-md-7">
                            <div className="testimonial-content">
                              ...
                              <p>
                                ...
                                mindblowing to get services. Delivering thorough
                                care to ensure client happiness.
                              </p>
                              <div className="author-area">
                                <h5>Jorche Milton</h5>
                      ...
                      <div className="testimonial-card4">
                        <div className="row g-4">
                          <div className="col-xl-4 col-md-5">
                            <div className="testimonial-img">
                              <img
                                src="/assets/img/home4/testimonial-img3.png"
                                alt=""
                              />
                              <a
                                style={{ cursor: "pointer" }}
                          ...
                          <div className="col-md-7">
                            <div className="testimonial-content">
                              ...
                              <p>
                                ...
                                professionalism and dedication of Topcode. From
                                our consultation to the final delivery.
                              </p>
                              <div className="author-area">
                                <h5>Hanry Macle</h5>
            ...
            <div
              className="col-lg-3 wow animate fadeInRight"
              data-wow-delay="200ms"
              data-wow-duration="1500ms"
            >
