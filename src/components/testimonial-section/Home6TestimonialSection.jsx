    ...
    <>
      <div className="home6-testimonial-section mb-130">
        <div className="container">
          ...
          >
            <div className="col-lg-5 col-md-8">
              <div className="section-title text-center">
                <h2>They Loves Us!</h2>
                <p>
                  Our target to bring satisaction of our customer &amp; also
                  we’ve 500+ happy customer in world-wide.
                </p>
              </div>
            </div>
          </div>
                          ...
                          <div className="col-md-8">
                            <div className="testimonial-content-wrap">
                              <div className="testimonial-content">
                                ...
                                <p>
                                  Topcode is a user-friendly,{" "}
                                  <span>support-based solution</span> that
                                  simplifies project management that
                          ...
                          <div className="col-md-8">
                            <div className="testimonial-content-wrap">
                              <div className="testimonial-content">
                                ...
                                <p>
                                  Topcode is{" "}
                                  <span>super fast &amp; most efficient</span>{" "}
                      ...
                      <div className="testimonial-card2 two">
                        <div className="row gy-4">
                          <div className="col-md-4">
                            <div className="testimonial-img">
                              <img
                                src="/assets/img/home2/testimonial-author-img4.png"
                                alt=""
                              />
                              <a
                                className="video-player"
          ...
          <div
            className="rating-wrap wow animate fadeInUp"
            data-wow-delay="200ms"
            data-wow-duration="1500ms"
          >
