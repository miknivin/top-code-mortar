        ...
        <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
          ...
          <ul className="menu-list">
            ...
            >
              ...
              />
              <ul
                className={`sub-menu d-lg-none ${
                  state.activeMenu === "HOME" ? "d-block" : "none"
                }`}
              >
                <li className="">
                  ...
                  <i
                    ...
                    className={`d-lg-none d-flex bi bi-${
                      state.activeSubMenu === "light" ? "dash" : "plus"
                    } dropdown-icon`}
                  />
                  <ul
                    className={`sub-menu ${
                      state.activeSubMenu === "light" ? "d-block" : "none"
                    }`}
                  >
                    <li className={pathname === "/" ? "active" : ""}>
                      <Link href="/">Startup Agency</Link>
                    </li>
                    <li className={pathname === "/fintech" ? "active" : ""}>
                      <Link href="/fintech">Fintech</Link>
                    </li>
                    <li
                      className={pathname === "/digital-agency" ? "active" : ""}
                    >
                      <Link href="/digital-agency">Digital Agency</Link>
                    </li>
                    <li
                      className={
                        pathname === "/marketing-agency" ? "active" : ""
                      }
                    >
                      <Link href="/marketing-agency">Marketing Agency</Link>
                    </li>
                    <li
                      className={pathname === "/it-consulting" ? "active" : ""}
                    >
                      <Link href="/it-consulting">IT Consulting</Link>
                    </li>
                    <li
                      className={pathname === "/saas-product" ? "active" : ""}
                    >
                ...
                <li>
                  ...
                  <i
                    ...
                    className={`d-lg-none d-flex bi bi-${
                      state.activeSubMenu === "dark" ? "dash" : "plus"
                    } dropdown-icon`}
                  />
                  <ul
                    className={`sub-menu ${
                      state.activeSubMenu === "dark" ? "d-block" : "none"
                    }`}
                  >
                    <li className={pathname === "/" ? "active" : ""}>
                      <Link href="/startup-agency-dark">Startup Agency</Link>
                    </li>
                    <li
                      className={pathname === "/fintech-dark" ? "active" : ""}
                    >
                      <Link href="/fintech-dark">Fintech</Link>
                    </li>
                    <li
                      className={
                        pathname === "/digital-agency-dark" ? "active" : ""
                      }
                    >
                    ...
                    <li
                      className={
                        pathname === "/marketing-agency-dark" ? "active" : ""
                      }
                    >
                    ...
                    <li
                      className={
                        pathname === "/it-consulting-dark" ? "active" : ""
                      }
                    >
                      <Link href="/it-consulting-dark">IT Consulting</Link>
                    </li>
                    <li
                      className={
                        pathname === "/saas-product-dark" ? "active" : ""
                      }
                    >
                      <Link href="/saas-product-dark">SaaS Product</Link>
                    </li>
                    <li
                      className={pathname === "/portfolio-dark" ? "active" : ""}
                    >
                ...
                <div className="container">
                  <div className="row gy-5">
                    ...
                    <div className="col-lg-3">
                      <div
                        className={`single-menu-item ${
                          pathname === "/digital-agency" ||
                          pathname === "/digital-agency-dark"
                            ? "active"
                            : ""
                        }`}
                      >
                    ...
                    <div className="col-lg-3">
                      <div
                        className={`single-menu-item ${
                          pathname === "/marketing-agency" ||
                          pathname === "/marketing-agency-dark"
                            ? "active"
                            : ""
                        }`}
                      >
                    ...
                    <div className="col-lg-3">
                      <div
                        className={`single-menu-item ${
                          pathname === "/it-consulting" ||
                          pathname === "/it-consulting-dark"
                            ? "active"
                            : ""
                        }`}
                      >
                    ...
                    <div className="col-lg-3">
                      <div
                        className={`single-menu-item ${
                          pathname === "/saas-product" ||
                          pathname === "/saas-product-dark"
                            ? "active"
                            : ""
                        }`}
                      >
            ...
            <li
              className={`menu-item-has-children position-inherit ${
                pathname === "/industry/details" ? "active" : ""
              }`}
            >
            ...
            >
              ...
              >
                ...
                <li className={pathname.startsWith("/case") ? "active" : ""}>
                  ...
                  <ul
                    className={`sub-menu ${
                      state.activeSubMenu === "case-study" ? "d-block" : "none"
                    }`}
                  >
                    ...
                    >
                      <Link href="/case-study/style2">Case Study Style 02</Link>
                    </li>
                    <li
                      className={
                ...
                <li className={pathname.startsWith("/news") ? "active" : ""}>
                  ...
                  >
                    ...
                    <li
                      className={
                        pathname === "/news-insight-grid/style2" ? "active" : ""
                      }
                    >
                    ...
                    <li
                      className={
                        pathname === "/news-insight-grid/style3" ? "active" : ""
                      }
                    >
                ...
                <li className={pathname.startsWith("/career") ? "active" : ""}>
                  ...
                  >
                    ...
                    <li
                      className={pathname === "/career/details" ? "active" : ""}
                    >
            ...
            >
              ...
              >
                <li
                  className={pathname === "/portfolio/classic" ? "active" : ""}
                >
                  <Link href="/portfolio/classic">Portfolio Classic</Link>
                </li>
                <li
                  className={pathname === "/portfolio/creative" ? "active" : ""}
                >
                  <Link href="/portfolio/creative">Portfolio Creative</Link>
                </li>
                <li
                  className={pathname === "/portfolio/caption" ? "active" : ""}
                >
                ...
                >
                  <Link href="/portfolio/horizontal">Portfolio Horizontal</Link>
                </li>
                <li
                  className={pathname === "/portfolio/carousel" ? "active" : ""}
                >
                  <Link href="/portfolio/carousel">Portfolio Carousel</Link>
                </li>
                <li
                  className={pathname === "portfolio/vertical" ? "active" : ""}
                >
                ...
                <li className={pathname === "/portfolio/grid" ? "active" : ""}>
                  <Link href="/portfolio/grid">Portfolio Grid</Link>
                </li>
                <li
                  className={pathname === "/portfolio/details" ? "active" : ""}
                >
            ...
            <li className="menu-item-has-children position-inherit">
              ...
              <i
                ...
                className={`bi bi-${
                  state.activeMenu === "resources" ? "dash" : "plus"
                } dropdown-icon`}
              />
              <div
                className={`mega-menu2 two ${
                  state.activeMenu === "resources" ? "d-block" : "none"
                }`}
              >
                <div className="container">
                  <div className="row align-items-lg-end justify-content-between">
                      ...
                      <div className="row">
                        <div className="col-lg-6">
                          <div className="menu-blog-card">
                            <Link
                              href="/news-insight-grid/details"
                              className="blog-img"
                            >
                              <img
                                src="/assets/img/home1/menu-blog-img1.jpg"
                                alt=""
                              />
                            </Link>
                        ...
                        <div className="col-lg-6">
                          <div className="menu-blog-card">
                            ...
                            >
                              <img
                                src="/assets/img/home1/menu-blog-img2.jpg"
                                alt=""
                              />
                            </Link>
                            <div className="blog-content">
