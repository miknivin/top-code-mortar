    ...
    <div className="home1-feature-section mb-80">
      <div className="container">
        <div className="feature-banner-area">
          <div
            className="banner-content wow animate fadeInDown"
            data-wow-delay="200ms"
            data-wow-duration="1500ms"
          >
            <span>What we do</span>
            <h2>Solve Grow Succeed</h2>
            <p>
              Handling the tricky stuff, solving complex problems, and achieving
              success.
            </p>
          </div>
        </div>
        <div className="feature-card-area">
          ...
          <div className="row g-4 mb-50">
            ...
            >
              <div className="feature-card">
                ...
                <h3>Insight &amp; Alignment</h3>
                <p>
                  We understand your goals and craft solutions that fit your
                  vision perfectly.
                </p>
              </div>
            </div>
            ...
            >
              <div className="feature-card two">
                ...
                <p>
                  We bring fresh ideas and smart technology to make your brand
                  stand out.
                </p>
              </div>
            </div>
            ...
            >
              <div className="feature-card">
                ...
                <h3>Commitment &amp; Excellence</h3>
                <p>
                  Every detail matters—we deliver work that looks and works
                  flawlessly.
                </p>
              </div>
            </div>
            ...
            >
              <div className="feature-card three">
                ...
                <h3>
                  Reliability &amp; <br /> Trust
                </h3>
                <p>
                  We value your time and deliver consistent, transparent,
                  reliable results.
                </p>
              </div>
            </div>
          ...
          <div
            className="contact-btn-area wow animate fadeInUp"
            data-wow-delay="200ms"
            data-wow-duration="1500ms"
          >
            <h6>
              Don’t Hesitate to <span>Collaborate</span> with Us.
            </h6>
