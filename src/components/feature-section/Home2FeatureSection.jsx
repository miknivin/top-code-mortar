          ...
          >
            <div className="feature-card2 magnetic-item">
              <div className="feature-content">
                ...
                <p>
                  End-to-end encryption for securing data during transactions.{" "}
                  <span>2FA security alert.</span>
                </p>
              </div>
            ...
            <div className="feature-card2 magnetic-item">
              <div className="feature-content">
                ...
                <p>
                  ...
                  <span>without traditional bank</span> involvement.
                </p>
              </div>
              <div className="feature-img">
          ...
          >
            <div className="feature-card2 magnetic-item">
              <div className="feature-content">
                ...
                <p>
                  <span>AI-driven analysis</span> of spending habits and
                  financial health.
                </p>
              </div>
              <div className="feature-img">
          ...
          >
            <div className="feature-contact-banner">
              <div className="banner-content">
                ...
                <p>Happy Customer by Using Topcode.</p>
              ...
              <div className="banner-img">
                <img
                  src="/assets/img/home2/feature-contact-banner-img.png"
                  alt=""
                />
              </div>
            </div>
