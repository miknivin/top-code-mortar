...
const Home2FooterSection = () => {
  useEffect(() => {
    window.addEventListener("scroll", function () {
      const appbackimg = document.querySelector(
        ".home2-app-banner-section .banner-img"
      );
      if (appbackimg) {
        // Check if the element exists
        const getAppBlockHeight = appbackimg.getBoundingClientRect().y;
        appbackimg.classList.toggle(
          "animate-back-img",
          320 >= getAppBlockHeight
        );
      }
    });
  });
            ...
            <div className="row">
              ...
              >
                <div className="banner-content">
                  <div className="section-title two">
                    ...
                    <p>
                      Topcode is essential in binding bricks, stones, and
                      concrete blocks together, providing the structural
                      integrity.
                    </p>
                  </div>
                  <ul className="store-list">
                    <li>
                      <a href="#">
                        <img
                          src="/assets/img/home2/play-store-icon.png"
                          alt=""
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          src="/assets/img/home2/app-store-icon.png"
                          alt=""
                        />
                      </a>
                    </li>
              ...
              <div className="col-lg-6 d-lg-block d-none">
                <div className="banner-img">
                  <img
                    src="/assets/img/home2/home2-app-banner-front-img.png"
                    alt=""
                  />
                  <img
                    src="/assets/img/home2/home2-app-banner-back-img.png"
                    alt=""
                    className="back-img"
                  />
                </div>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10 d-flex justify-content-center text-center">
              <div className="contact-content">
                <div
                  className="section-title two text-center wow animate fadeInDown"
                  data-wow-delay="200ms"
                  data-wow-duration="1500ms"
                >
                  <span>Help Line</span>
            ...
            <div className="footer-contact-wrap">
              ...
              <ul className="contact-list">
                <li className="single-contact">
                  <div className="icon">
                    <img
                      src="/assets/img/home1/icon/contact-whtsapp-icon.svg"
                      alt=""
                    />
                  </div>
              ...
              <div className="col-lg-3 col-sm-6 d-flex justify-content-lg-center">
                <div className="footer-widget">
                  ...
                  <ul className="widget-list">
                    ...
                    <li>
                      <Link href="/service/details">Financial Inclusion</Link>
                    </li>
                    <li>
                      <Link href="/service/details">Enterprise Financial</Link>
                    </li>
                    <li>
                      <Link href="/service/details">Crowdfunding</Link>
                    </li>
                    <li>
                      <Link href="/service/details">Payment Gateway</Link>
                    </li>
                  </ul>
                </div>
              </div>
